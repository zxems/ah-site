...
const defaultPlaylist = [
  {
    ...
    src: "/placeholder-song.mp3",
  },
  {
    id: 2,
    title: "Sweet",
    artist: "Cigarettes After Sex",
    src: "/sweet-cas.mp3", // Replace with actual song
  },
  {
    id: 3,
    title: "Superpowers",
    artist: "Daniel Ceaser",
    src: "/superpowers-dc.mp3", // Replace with actual song
  },
]
        ...
        <div className="flex items-center space-x-2">
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              <SheetHeader>
                <SheetTitle>Music Playlist</SheetTitle>
                <SheetDescription>Select a song from your playlist</SheetDescription>
              </SheetHeader>
